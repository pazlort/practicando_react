const CartWidget = () => {
    return (
        <button type="button" className="btn btn-outline-danger order-lg-1">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-1-circle-fill" viewBox="0 0 16 16">
